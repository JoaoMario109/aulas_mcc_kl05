...
typedef enum{
	...
	TPM_PWM_HIGH_LOW_CONFIG		,	/*Modos PWM: Pulso é o baixo*/
}tpmChConfig_t;
 ...
 *
 * Comentários 	: 	Pode ser chamada após a inicialização (TPM_Init).
 *                  Porém, contador vai iniciar contagem apenas quando
 ...
 *
 * Descrição	:   Inicializa registrador contador do módulo TPM0.
 *
 * Entradas		:   *base - registrador base do periférico TPM.
 *
 * Saídas		:   Nenhuma.
