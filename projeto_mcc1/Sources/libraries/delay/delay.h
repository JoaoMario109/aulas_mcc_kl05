...
#include "mcu_general_config.h" /*!< To call specific Kinetis SDK clock API to use in DELAY_CLOCK_FREQUENCY macro!*/
...
#define DELAY_CLOCK_FREQUENCY SystemCoreClock /*!< Specific microcontroller CPU clock frequency. */
